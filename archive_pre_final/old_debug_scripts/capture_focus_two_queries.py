"""
Snapshot hybrid/vector metrics for regression + two weak queries.
Writes JSON to outputs/focus_two_queries_metrics.json (single file; run twice for before/after).
"""
...
def main() -> None:
    try:
        ...
        pass
    out_path = Path("outputs") / "focus_two_queries_metrics.json"
